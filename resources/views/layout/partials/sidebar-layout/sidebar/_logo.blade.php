...
<div class="app-sidebar-logo px-6" id="kt_app_sidebar_logo">
	...
	<a href="{{ route('dashboard') }}">
		<img alt="Logo" src="{{ image('logos/WeQuote_logo.png') }}" class="h-40px app-sidebar-logo-default" />
		<img alt="Logo" src="{{ image('logos/WeQuote_logo.png') }}" class="h-35px app-sidebar-logo-minimize" />
	</a>
	<!--end::Logo image-->
