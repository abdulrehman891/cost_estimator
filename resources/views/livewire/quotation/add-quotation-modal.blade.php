            ...
            <div class="modal-content modal-rounded">
                ...
                <div class="modal-body scroll-y m-5">
                    ...
                    <div class="stepper stepper-pills" id="kt_stepper_example_clickable">
                        ...
                        <!--begin::Form-->
                        <form class="form w-lg-500px mx-auto" wire:submit.prevent novalidate="novalidate" id="kt_stepper_example_basic_form">
                            <!--begin::Group-->
                            <div class="mb-5">
                                <!--begin::Step 1-->
                                ...
                                <div class="flex-column" data-kt-stepper-element="content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-4">
                                            ...
                                            <input type="text" wire:model.defer="deck_type" name="deck_type" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Deck Type"/>
                                        </div>
                                    </div>
                                                ...
                                                <div data-repeater-item>
                                                    <div class="card m-2">
                                                        ...
                                                        <div class="fv-row m-5">
                                                            ...
                                                            <!--end::Label-->
                                                            <select class="form-select" name="product" onchange="changeProductEvent(this)" data-placeholder="Select an option">
                                                                <option></option>
                                                        ...
                                                        <div class="form-group row m-5">
                                                            <div class="col-md-6 mb-4">
                                                                ...
                                                                <input type="text" name="unit_price" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Unit Price"/>
                                                            </div>
                                                            <div class="col-md-6 mb-4">
                                                                <label class="required fw-semibold fs-6 mb-2">Discount Price</label>
                                                                <input type="text" name="discount_price" onkeyup="changeDiscountEvent(this)" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Discount Price"/>
                                                            </div>

                                                            <div class="col-md-6 mb-4">
                                                                <label class="required fw-semibold fs-6 mb-2">Quantity</label>
                                                                <input type="text" name="quantity" onkeyup="changeQuantityEvent(this)" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Quantity"/>
                                                            </div>

                                                            <div class="col-md-6 mb-4">
                                                                <label class="required fw-semibold fs-6 mb-2">Total Price</label>
                                                                <input type="text" name="total_price" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Total Price"/>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row mb-5">
                                                            <div class="col-md-12 text-center">
                                                                <a href="javascript:;" data-repeater-delete class="btn btn-flex btn-sm btn-light-danger">
                        ...
                        <span class="indicator-label">
                            ...
                            Please wait... <span class="spinner-border spinner-border-sm align-middle ms-2"></span>
                                    ...
                                    <button type="button" class="btn btn-primary" data-kt-stepper-action="next" id="continue_next">
                                        Continue
                                    </button>
