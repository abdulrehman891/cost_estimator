                                        ...
                                        <div class="card m-2">
                                            ...
                                            <div class="form-group row m-5">
                                                <div class="fv-row mb-10">
                                                    ...
                                                    @error('project_milestone.'.$index) <span class="text-danger">{{ $message }}</span> @enderror
                                                </div>
                                                <div class="fv-row mb-10">
                                                    <label class="fw-semibold fs-6 mb-2">Milestone Description</label>
                                                    <textarea name="milestone_description" id="milestone_description" wire:model.defer="milestone_description.{{$index}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Milestone Description"> </textarea>
                                                </div>
                                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <textarea id="proposal_preview" name="proposal_preview" style="display: none">
                                           {!! nl2br($chatGPT_res) !!}
                                            ...
                                            <button type="button" class="btn btn-primary" wire:click="previewProposal">
                                                <span class="indicator-label" >Preview</span>
                                            </button>
                                            <button type="button" class="btn btn-primary" wire:click="regenerateProposal">
